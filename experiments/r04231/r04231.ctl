...
experiment_folder:/Users/jacob.cooper/kinase_assay_builder/experiments/r04231/

# compound list (.txt) (relative to experiment folder path)
compound_list:r04231_compound_list.txt
